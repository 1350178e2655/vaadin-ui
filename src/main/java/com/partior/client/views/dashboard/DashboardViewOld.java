...
import com.partior.client.views.dashboard.ServiceHealth.Status;
...
@PageTitle("Dashboard")
@Route(value = "dashboardOld", layout = MainLayout.class)
@PermitAll
public class DashboardViewOld extends Main {

    public DashboardViewOld() {
