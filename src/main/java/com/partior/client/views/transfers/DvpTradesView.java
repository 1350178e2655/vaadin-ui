...
@Route(value = "dvp-trades-view", layout = MainLayout.class)
@PageTitle("PVP Trades")
@PermitAll
public class DvpTradesView extends SplitViewFrame {
    ...
    public DvpTradesView(CantonDataService cantonDataService, AuthenticatedUser authenticatedUser) throws Exception {
    ...
    private Component createForm() throws Exception {
        FlexBoxLayout form = new FlexBoxLayout(
                new DvpTradesForm(cantonDataService, authenticatedUser)
        );
