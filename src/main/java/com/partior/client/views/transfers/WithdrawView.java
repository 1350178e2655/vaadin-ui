...
@Route(value = "withdraw_transaction", layout = MainLayout.class)
@PageTitle("Transaction Withdraw")
@PermitAll
public class WithdrawView extends ViewFrame {

    @Autowired
    final CantonDataService cantonDataService;

    public WithdrawView(CantonDataService cantonDataService) throws Exception {
...
//        content.setFlexDirection(FlexLayout.FlexDirection.COLUMN);
    ...
    private Component createForm() throws Exception {
        FlexBoxLayout form = new FlexBoxLayout(
                new WithdrawForm(cantonDataService)
        );
        form.setHeightFull();
        form.setWidthFull();
