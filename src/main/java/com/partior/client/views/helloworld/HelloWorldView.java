package com.partior.client.views.helloworld;


import com.partior.client.views.MainLayout;
import com.partior.client.views.helloworld.ServiceHealth.Status;
...
@RouteAlias(value = "ccccccc", layout = MainLayout.class)
@RolesAllowed("ADMIN")
public class HelloWorldView extends Main {
    ...
    public HelloWorldView() {
        ...
        board.addRow(createHighlight("CBDC", "2", 0.00), createHighlight("Account Owner", "10", -112.45),
                createHighlight("CDBC Account", "18", 3.9), createHighlight("RTGS Account", "10", 0.0));
