...
@Route(value = "rtgs_withdrawal_transaction", layout = MainLayout.class)
@PageTitle("AccountOwner List")
@PermitAll
public class ListRtgsApprovedTransactionsView extends SplitViewFrame {
    ...
    public ListRtgsApprovedTransactionsView(CantonDataService cantonDataService) throws Exception {
    ...
    private Component createPendingTransactionContent() throws Exception {
        FlexBoxLayout content = new FlexBoxLayout(
                createHeader(VaadinIcon.WALLET, "Pending Txn"),
    ...
    private Grid createPendingTransactionGrid() throws Exception {
        ...
        pendingTransactionDataProvider = DataProvider.ofCollection(cantonDataService.listPendingWithdrawals(cantonDataService.getCdbcOperator(), cantonDataService.getUserBankName() ));
    ...
    private Component createCompletedTransactionContent() throws Exception {
        FlexBoxLayout content = new FlexBoxLayout(
                createHeader(VaadinIcon.WALLET, "Completed Txn"),
    ...
    private Grid createCompletedTransactionGrid() throws Exception {
        ...
        approvedTransactionDataProvider = DataProvider.ofCollection(cantonDataService.listApprovedWithdrawals(cantonDataService.getCdbcOperator() , cantonDataService.getUserBankName()));


        approvedTransactionHistory.setDataProvider(pendingTransactionDataProvider);
    ...
    private String toShortName(RtgsTransactionResponseProposalDto withdrawalResponseProposalDto){
        return withdrawalResponseProposalDto.getAccount().getAccountOwner().getShortName();
    }

    private String toAccountId(RtgsTransactionResponseProposalDto withdrawalResponseProposalDto){
        return withdrawalResponseProposalDto.getAccount().getAccountId();
    }
