...
@Route(value = "rtgs-pending-transaction", layout = MainLayout.class)
@PageTitle("RTGS Pending transactions")
@PermitAll
public class ListRtgsTransactionsView extends SplitViewFrame {
    ...
    public ListRtgsTransactionsView(CantonDataService cantonDataService) throws Exception {
