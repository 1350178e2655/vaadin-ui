package com.partior.client.ui.components.navigation.bar;

import com.partior.client.security.AuthenticatedUser;
import com.partior.client.ui.components.FlexBoxLayout;
import com.partior.client.ui.components.navigation.tab.NaviTab;
import com.partior.client.ui.components.navigation.tab.NaviTabs;
import com.partior.client.ui.util.LumoStyles;
import com.partior.client.ui.util.UIUtils;

import com.partior.client.views.Home;
...
import static com.partior.client.ui.util.UIUtils.IMG_PATH;
...
public class AppBar extends FlexBoxLayout {
	...
	private com.partior.client.ui.components.ListItem  avatar;
	...
	public AppBar(String title, AuthenticatedUser authenticatedUser, User user, String domain, NaviTab... tabs) {
		...
		initTitle(title);
		initSearch();
		initAvatar(authenticatedUser, user, domain);
		initActionItems();
		initContainer();
		initTabs(tabs);
	}
	...
	private void initAvatar(AuthenticatedUser authenticatedUser, User user, String domain) {

        avatar =  new com.partior.client.ui.components.ListItem(
                new com.partior.client.ui.components.Initials( user.getUsername().substring(0,1)),
                user.getUsername(), domain );

        //new Avatar( user.getUsername() );
	...
	public com.partior.client.ui.components.ListItem  getAvatar() {
		return avatar;
	}
