...
import com.partior.client.ui.util.css.WhiteSpace;
...
public class ListItem extends FlexBoxLayout {
    ...
    public ListItem(String primary, String secondary) {
		...
		setPadding(com.partior.client.ui.layout.size.Wide.RESPONSIVE_L);
		setSpacing(Right.L);

		this.primary = new Label(primary);
		this.secondary = UIUtils.createLabel(FontSize.S, TextColor.YELLOW,
				secondary);
    ...
    public ListItem(String primary, String secondary, String third, String fourth) {
        addClassName(CLASS_NAME);
        ...
        this.primary = new Label(primary);
        this.secondary = UIUtils.createLabel(FontSize.S, TextColor.BLUE, secondary);
        this.third = UIUtils.createLabel(FontSize.S, TextColor.BLUE, third);
        this.fourth = UIUtils.createLabel(FontSize.S, TextColor.BLUE, fourth);



        content = new FlexBoxLayout(this.primary, this.secondary, this.third, this.fourth);
        content.setClassName(CLASS_NAME + "__content");
        content.setFlexDirection(FlexDirection.COLUMN);
    ...
    public ListItem(String primary, String secondary, String third) {
        addClassName(CLASS_NAME);
        ...
        content = new FlexBoxLayout(this.primary, this.secondary, this.third);
        content.setClassName(CLASS_NAME + "__content");
        content.setFlexDirection(FlexDirection.COLUMN);
        add(content);
    }
