package com.partior.client.ui.components.navigation.drawer;
...
public class BrandExpression extends Div {
	...
	public BrandExpression(String text) {
		...
		logo = new Image(UIUtils.IMG_PATH + "logos/top-left-logo.png", "");
		...
		//add(logo, title, UIUtils.createH1Label(domain ));
        add(logo, title);
	}
